        ...
        <div class="container-fluid">
            <?php if ($_SERVER['REQUEST_URI'] == '/') { ?>
                ...
                <div>
                    ...
                    <button form="products_form" type="submit" class="btn btn-danger my-2 my-sm-0 mx-1" id="delete-product-btn">MASS DELETE
                    </button>
                <?php } ?>
                <?php if ($_SERVER['REQUEST_URI'] == '/add-product') { ?>
                    <a href='/add-product' class="navbar-brand mb-0 h1">
                        Product Add</a>
                    <div>
                        <input form="product_form" href="add-product" type="submit" name="submit" value="Save" class="btn btn-success ml-4" id="save">
